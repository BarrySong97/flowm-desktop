 ...
 * @gotcha  Client component: card ① is a static 4×2 grid of source logos (no background/lines);
...
// ── 卡片①「汇总」：来源各异的 app 图标，排成无背景、无边框的 4×2 宫格，体现「来源一大堆」。 ──
const ALIPAY_D =
...
function SourcesGridViz() {
  return (
    <div className="grid h-[260px] grid-cols-4 grid-rows-2 gap-3">
      {SOURCE_ICONS.map((s) => (
