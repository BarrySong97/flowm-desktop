    ...
    groups: [
      {
        title: "桌面应用",
        items: [
          "将底部悬浮导航改为常驻顶部标签栏，统一看板、资产、流水、订阅、贷款、预算和设置的入口",
          "修复 Tauri 原生窗口拖拽区域和权限配置，切换页面后仍可从顶部空白区域移动窗口",
          "顶部导航继续提供金额隐藏开关，并与页面内容保持一致的水平边距",
        ],
      },
      {
        title: "首页",
        items: [
          "首页改为左侧财务摘要、右侧最近流水的双栏工作台，减少为了查看核心信息而滚动页面",
          "压缩预算和即将扣费区域的信息密度，并保留进入完整列表的入口",
          "最近流水使用适合窄栏的日期、项目、类别和金额四列布局",
        ],
      },
    ],
  },
