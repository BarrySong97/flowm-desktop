...
// Ported for the marketing mock: the desktop file imports RouterOutputs from
// "@/lib/trpc", but the mock tRPC proxy is untyped, so we declare the minimal
// loan/occurrence shapes the schedule builder actually reads.
export type LoanSummary = {
  ...
  currentPrincipalEstimate?: string | number | null
  annualRateBps?: number | null
  paymentAmount?: string | number | null
  termMonths?: number | null
}
export type LoanOccurrence = {
